    ...
    return (
        <Box className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <Box className="bg-card w-full max-w-2xl max-h-[90vh] rounded-2xl sm:rounded-[2rem] border border-border/50 shadow-2xl overflow-hidden flex flex-col">
                ...
                {/* Scrollable Content */}
                <Box
                    className="flex-1 overflow-y-auto p-4 sm:p-6 text-foreground"
                    onScroll={handleScroll}
                >
                    <VStack space="lg">
                        {/* Introduction */}
                        <Box className="bg-secondary/30 rounded-xl p-4 border border-border/20">
                            <VStack space="md">
                        ...
                        <Box className="bg-secondary/30 rounded-xl p-4 border border-border/20">
                            <VStack space="md">
                                ...
                                <VStack space="sm" className="ml-3 mt-1">
