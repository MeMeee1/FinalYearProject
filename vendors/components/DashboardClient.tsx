        ...
        <div className="relative overflow-hidden p-6 rounded-[2rem] bg-gradient-to-br from-yellow-500/10 to-yellow-500/5 border border-yellow-500/20 mb-10 group">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4 relative z-10">
            ...
            <div className="flex-1">
              ...
              <Text className="text-sm text-muted-foreground font-medium max-w-2xl mb-2">
              ...
              <div className="flex items-center gap-2 mb-4 bg-red-500/10 border border-red-500/20 px-4 py-2 rounded-xl inline-flex">
                <Clock className="w-4 h-4 text-red-500" />
                <Text className="text-sm font-black text-red-500">
                  You have 5 days to complete verification or your account may be suspended.
                </Text>
              </div>
              {activeProfile?.fulfillmentPoint && (
                <div className="bg-card/50 backdrop-blur-sm p-5 rounded-2xl border border-border/50 space-y-4">
                  <div>
                    <Text className="text-xs font-black text-primary uppercase tracking-wider mb-2 flex items-center gap-2">
                  ...
                  <div className="border-t border-border/50 pt-4">
                    <Text className="text-xs font-black text-orange-500 uppercase tracking-wider mb-2 flex items-center gap-2">
                      <CalendarClock className="w-3 h-3" /> Verification Hours:
                    </Text>
                    <Text className="font-bold text-foreground">Monday - Friday: 9:00 AM - 5:00 PM</Text>
                    <Text className="text-xs text-muted-foreground font-medium mt-1">Saturday: 10:00 AM - 2:00 PM (No service on Sundays)</Text>
                    <Text className="text-xs text-yellow-600 font-bold mt-3 bg-yellow-500/10 px-3 py-2 rounded-lg inline-block">
